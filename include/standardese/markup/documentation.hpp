...
namespace standardese
{
    namespace markup
    {
        ...
        public:
            ...
            /// \returns An iteratable object iterating over all the sections (including brief and details),
        ...
        public:
            ...
            public:
                ...
                /// \requires The user data of the entity must either be `nullptr` or the corresponding [standardese::doc_entity]().
        ...
        private:
            entity_documentation(type_safe::object_ref<const cppast::cpp_entity> entity,
                                 block_id id, type_safe::optional<documentation_header> h,
                                 std::unique_ptr<code_block> synopsis)
            : documentation_entity(std::move(id), std::move(h), std::move(synopsis)),
              entity_(entity)
            {
            }
        ...
        public:
            ...
            public:
                /// \effects Creates it giving the id, header and synopsis.
                /// \requires The user data of the file must either be `nullptr` or the corresponding [standardese::doc_entity]().
