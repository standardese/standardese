...
namespace standardese
{
    namespace markup
    {
        ...
        public:
            /// A special [standardese::markup::text]() entity that represents a certain syntax highlighting.
            ///
            /// The HTML renderer will use a `<span>` block with classes as used in [code prettify](https://github.com/google/code-prettify).
            /// In particular:
