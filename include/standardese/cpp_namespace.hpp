...
namespace standardese
{
    ...
    public:
        ...
        {
        public:
            parser(const standardese::parser &, const cpp_name &scope, cpp_cursor cur);
    ...
    {
    public:
        static cpp_ptr<cpp_namespace_alias> parse(const parser &p,  cpp_name scope, cpp_cursor cur);
    ...
    {
    public:
        static cpp_ptr<cpp_using_directive> parse(const parser &p,  cpp_cursor cur);
    ...
    {
    public:
        static cpp_ptr<cpp_using_declaration> parse(const parser &p,  cpp_cursor cur);
