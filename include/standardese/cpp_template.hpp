...
namespace standardese
{
    ...
    {
    public:
        static cpp_ptr<standardese::cpp_template_parameter> try_parse(const parser &p, cpp_cursor cur);
    ...
    {
    public:
        static cpp_ptr<cpp_template_type_parameter> parse(const parser &p,  cpp_cursor cur);
    ...
    {
    public:
        static cpp_ptr<cpp_non_type_template_parameter> parse(const parser &p,  cpp_cursor cur);
    ...
    {
    public:
        static cpp_ptr<cpp_template_template_parameter> parse(const parser &p,  cpp_cursor cur);
    ...
    {
    public:
        static cpp_ptr<cpp_function_template> parse(const parser &p,  cpp_name scope, cpp_cursor cur);
    ...
    {
    public:
        static cpp_ptr<cpp_function_template_specialization> parse(const parser &p,  cpp_name scope, cpp_cursor cur);
