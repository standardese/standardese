...
namespace standardese
{
    ...
    public:
        ...
        bool register_documentation(std::string link_name, const markup::document_entity& document,
                                    const markup::block_id& documentation,
    ...
    /// Registers every [cppast::cpp_entity]() that is not documented but would have been documented in that file, using a documented parent's unique name.
    /// \notes This function is thread safe.
