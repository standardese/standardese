...
namespace standardese
{
    ...
    {
    public:
        static cpp_ptr<cpp_variable> parse(const parser &p,  cpp_name scope, cpp_cursor cur);
    ...
    {
    public:
        static cpp_ptr<cpp_member_variable> parse(const parser &p,  cpp_name scope, cpp_cursor cur);
