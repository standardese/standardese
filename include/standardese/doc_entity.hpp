...
namespace standardese
{
    ...
    public:
        enum flag
        {
            ...
            show_group_output_section, //< If set, the name of the group will be shown as output section.
        ...
        synopsis_config()
        : hidden_name_(default_hidden_name()),
          tab_width_(default_tab_width()),
    ...
    ///
    /// This will be the user data of all non-excluded [cppast::cpp_entity]() that are neither files nor namespaces.
    ...
    private:
        doc_cpp_entity(std::string                                         link_name,
    ...
    private:
        doc_cpp_file(std::string output_name, std::string link_name,
                     std::unique_ptr<cppast::cpp_file>                   file,
                     type_safe::optional_ref<const comment::doc_comment> comment)
        : doc_entity(std::move(link_name), comment),
